...
// ---------- CONFIG ----------
const BOT_TOKEN = "8650935419:AAH9_ySljLmaLv_wdNLw4qipjx5uCOZCkKU";
const ADMIN_ID = 334179105;
const BOT_USERNAME = "BotBusinessUP_bot";
const WEBHOOK_SECRET = "bu_wh_7f3a9c2e8d145b6a";
const ADMIN_API_KEY = "bu_admin_3e91c7a05f2d48b6";
const CRON_SECRET = "bu_cron_5a8b2f1d9e3c47b0";
